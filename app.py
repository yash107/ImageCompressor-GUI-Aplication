import sys
from PyQt5.QtWidgets import QInputDialog,QApplication, QWidget,QMainWindow,QFrame,QLabel, QLineEdit,QPushButton,QComboBox,QFileDialog
...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.dir_bubble_para.setText("Want to compress multiple images at once?Select the folder and get the compressed version")
        self.dir_bubble_para.move(12,32)
        

        #------single bubble exapanded---------
        ...
        self.compress_image.move(120,260)
        #-----------single bubble end----
        ...
        self.compress_dir.move(120,290)
        #-------end directory bubble---------
        #------end -------------------------------
        self.show()
    #-----------functions----------
    ...
    def quality_current_value(self):
        ...
        if self.quality_combo.currentText()=="Medium":
            ...
            self.quality_path.setText(str(int((self.image_width/2)/2)))
    ...
    def select_file(self):
        fileName, _ = QFileDialog.getOpenFileName(self,"QFileDialog.getOpenFileName()", "","All Files (*);;JPG (*.jpg)")
        if fileName:
            print(fileName)
    ...
    def resize_pic(self):
        old_pic=self.image_path.text()
            ...
            #self.statusBar().showMessage("Message:Please choose a valid image")
            #return
        if old_pic=="":
        ...
        if okPressed and new_pic_name != '':
            ...
            directories = Path(self.image_path.text()).parts
            temp=directories[:-1]
            new_pic = os.path.join(*temp)+"\\"+new_pic_name
            print(new_pic)
    ...
    def resize_folder(self):
        ...
        #print(source_directory+"/"+files[0])
    ...
    def compression_code(self,old_pic,new_pic,mywidth):
        try:
            ...
            set.statusBar.showMessage("Message:"+e)
